...
- [第十章 对象和类（上）](#第十章-对象和类上)
  - [10.1 过程性编程和面向对象性编程](#101-过程性编程和面向对象性编程)
  - [10.2 类](#102-类)
    - [10.2.3 实现类成员函数](#1023-实现类成员函数)
    - [10.2.4 使用类](#1024-使用类)
    - [10.2.5 修改实现](#1025-修改实现)
  - [10.3 类的构造函数和析构函数](#103-类的构造函数和析构函数)
    - [10.3.1 声明和定义构造函数](#1031-声明和定义构造函数)
    - [10.3.2 使用构造函数](#1032-使用构造函数)
    - [10.3.3 默认构造函数](#1033-默认构造函数)
    - [10.3.4 析构函数](#1034-析构函数)
    - [10.3.5 改建 Stock 类](#1035-改建-stock-类)
  - [10.4 this 指针](#104-this-指针)
  - [10.5 对象数组](#105-对象数组)
  - [10.6 类作用域](#106-类作用域)
    - [10.6.1 作用域为类的常量](#1061-作用域为类的常量)
    - [10.6.2 作用域内枚举](#1062-作用域内枚举)
  - [10.7 抽象数据类型](#107-抽象数据类型)
---
# 第二章：开始学习C++ 
